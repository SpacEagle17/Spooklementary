vec3 GetColoredLightFog(vec3 playerPos, vec3 nPlayerPos, vec3 translucentMult, float lViewPos, float lViewPos1, float dither) {
    ...
    for (int i = 0; i < sampleCount; i++) {
        ...
        doPowerOutage(emission, lightmap, tracePos + cameraPosition, nearPlayerOutage, true);
