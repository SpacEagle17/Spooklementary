            ...
            if (mat < 10128) {
                if (mat < 10064) {
                    if (mat < 10032) {
                        if (mat < 10016) {
                            if (mat < 10008) {
                                if (mat < 10003) { // No directional shading
                        ...
                        if (mat < 10400) {
                            if (mat < 10392) {
                                ...
                                if (mat < 10396) { // Pumpkin, Carved Pumpkin
                                    ...
                                    float noiseAdd = 0.0;
                                    #ifdef GBUFFERS_TERRAIN
                                        noiseAdd = hash13(mod(floor(worldPos + atMidBlock / 64) + frameTimeCounter * 0.00001, vec3(100)));
                                    #endif
                        ...
                        if (mat < 10752) {
                            if (mat < 10744) {
                                ...
                                if (mat < 10748) { // Soul Sand, Soul Soil
                                    ...
                                    #ifdef GBUFFERS_TERRAIN
                                        if (mat == 10744) {
                                            vec3 colorSoul = vec3(0.1725, 0.8588, 0.8824);
